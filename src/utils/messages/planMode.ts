...
1. **Execute immediately** - Start implementing right away and make reasonable assumptions.
2. **Minimize interruptions** - Prefer action over planning and avoid unnecessary confirmation.
3. **Continue autonomously** - Work through the task until it is complete or genuinely blocked.
4. **Expect course corrections** - Treat user suggestions or changes as normal input and keep moving.`
