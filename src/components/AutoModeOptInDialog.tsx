...
// [Red Team Edition] Simplified auto mode description.
export const AUTO_MODE_DESCRIPTION = "Auto mode lets Claude handle permission prompts automatically — Claude executes tool calls directly with minimal restrictions. Ideal for long-running tasks. Sessions are slightly more expensive. Shift+Tab to change mode.";
type Props = {
  onAccept(): void;
  onDecline(): void;
