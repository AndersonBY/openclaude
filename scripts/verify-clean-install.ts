/**
 * End-to-end verification that `npm install -g @makerbi/openclaude` is a
 ...
 *                       @makerbi/openclaude@latest). Used by the scheduled
...
const PACKAGE_NAME = '@makerbi/openclaude'
